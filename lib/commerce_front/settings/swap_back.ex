defmodule CommerceFront.Settings.SwapBack do
  ...
  def changeset(swap_back, attrs) do
    swap_back
    |> cast(attrs, [:user_id, :user_wallet_address, :treasury_address, :amount_raw, :amount, :tx_hash, :status, :reason, :staff_id, :approved_at, :rate_used, :points_credited])
    |> validate_required([:user_id, :user_wallet_address, :treasury_address, :amount_raw, :amount, :tx_hash, :status, :reason, :staff_id, :approved_at, :rate_used, :points_credited])
  end
end
