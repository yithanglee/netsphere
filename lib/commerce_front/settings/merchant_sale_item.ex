defmodule CommerceFront.Settings.MerchantSaleItem do
  ...
  def changeset(merchant_sale_item, attrs) do
    merchant_sale_item
    |> cast(attrs, [:merchant_sales_id, :product_name, :product_price, :qty, :remarks, :item_pv, :img_url])
    |> validate_required([:merchant_sales_id, :product_name, :product_price, :qty, :remarks, :item_pv, :img_url])
  end
end
