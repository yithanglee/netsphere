  ...
  var commerceApp_ = {
    ...
    components: {
      merchantproduct() {
        ...
        phxApp_.api("get_mproduct", {
          ...
          function addToMCart() {
            var check2 = commerceApp_.mcart_.filter((v, i) => {
              return v.merchant_id == data2.merchant_id;
            });
            if (check2.length > 0) {
              commerceApp_.addItem_(data2, true);
      ...
      country() {
        if (localStorage.getItem("region") != null) {
          var sel = phxApp_.countries_.filter((v, i) => {
    ...
    `, crp = `RP <span class="format-float">` + subtotal;
        ...
        if (!showRP) {
          ...
          cshipping_fee = shipping_fee2 * phxApp_.chosen_country_id_.conversion;
          srp = (subtotal + shipping_fee2) * phxApp_.chosen_country_id_.conversion;
          currency = `MYR`;
        }
      ...
      product() {
        ...
        phxApp_.api("get_product", {
          ...
          if (includeShippingTax) {
            ...
            if (phxApp_.chosen_country_id_.name == "China" && ["DT2\u4F53\u9A8C\u5361\u914D\u5957", "DT2\u542F\u52A8\u914D\u5957", "2\u5F2099\u6B21\u5F00\u673A\u5361 DT2\u542F\u52A8\u914D\u5957"].includes(data2.name)) {
              rp = `<div class="font-sm fw-light text-secondary text-center "><span class="format-float">` + data2.retail_price * 1 + ` </span> RP</div>`;
            }
          }
          if (!showRP) {
            rp = `<div class="font-sm fw-light text-secondary text-center ">MYR <span class="format-float">` + data2.retail_price * phxApp_.chosen_country_id_.conversion + `</span></div>`;
            if (phxApp_.chosen_country_id_.name == "Malaysia") {
              includeShippingTax = false;
            } else {
              includeShippingTax = true;
            ...
            if (includeShippingTax) {
              rp = `<div class="font-sm fw-light text-secondary text-center ">MYR <span class="format-float">` + data2.retail_price * phxApp_.chosen_country_id_.conversion * 1.1 + `</span></div>`;
              if (phxApp_.chosen_country_id_.name == "Singapore") {
                rp = `<div class="font-sm fw-light text-secondary text-center ">MYR <span class="format-float">` + data2.retail_price * phxApp_.chosen_country_id_.conversion * 1.05 + `</span></div>`;
              }
            }
          }
