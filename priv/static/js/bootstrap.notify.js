...
(function(factory) {
  ...
  var defaults = {
    ...
    icon_type: 'class',
    template: `
      <div data-notify="container" class="d-flex justify-content-between align-items-center col-11 col-md-4 alert alert-{0}" role="alert">
        <div>
          <i data-notify="icon" class="material-icons" style="padding-right: 4px;"></i>
          <span class="fw-bold" data-notify="title">{1}</span> 
        ...
        <div class="btn" data-notify="dismiss">
  ...
  $.extend(Notify.prototype, {
    ...
    setIcon: function() {
      ...
      if (this.settings.icon_type.toLowerCase() === 'class') {
        this.$ele.find('[data-notify="icon"]').attr("class", this.settings.content.icon);
      } else {
